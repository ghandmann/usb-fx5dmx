 ...
 * contents of FX5DMX.xs. Do not edit this file, edit FX5DMX.xs instead.
 *
...
extern "C"
#endif
XS_EXTERNAL(boot_USB__FX5DMX); /* prototype to pass -Wmissing-prototypes */
XS_EXTERNAL(boot_USB__FX5DMX)
{
#if PERL_VERSION_LE(5, 21, 5)
    dVAR; dXSARGS;
#else
